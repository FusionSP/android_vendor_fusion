...
# Fusion version
RELEASE = false
FUSIONSP_VERSION_MAJOR = 5
FUSIONSP_VERSION_MINOR = 1

# release
ifeq ($(RELEASE),true)
    FUSIONSP_VERSION_STATE := OFFICIAL
    FUSIONSP_VERSION := Fusion-NIGHTLY-v$(FUSIONSP_VERSION_MAJOR).$(FUSIONSP_VERSION_MINOR)-$(FUSIONSP_VERSION_STATE)
else
    FUSIONSP_VERSION_STATE := $(shell date +%Y-%m-%d)
    FUSIONSP_VERSION := Fusion-v$(FUSIONSP_VERSION_MAJOR).$(FUSIONSP_VERSION_MINOR)-$(FUSIONSP_VERSION_STATE)
endif
