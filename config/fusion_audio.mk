...
ALARM_PATH := vendor/fusion/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/fusion/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/fusion/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/fusion/prebuilt/common/media/audio/ui
