...
#then
#	echo -e "${bldred}  Fusion ROM will be compiled using Linaro Toolchain... "
#else
#	echo -e "${bldred}  Fusion ROM will be compiled using the default GCC Toolchain..."
#fi
...
echo -e ""
echo -e ""
echo -e "${bldcya}  Starting compilation of Fusion Rom..."
echo -e ""
echo -e ""
$normal
make -j16 fusionsp
